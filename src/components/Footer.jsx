...
function Footer() {
  return (
    <div className='footer d-flex flex-column flex-wrap  justify-content-center bg-dark' style={{marginTop:'100px',width: '100%', height:'300px', lineHeight: '35px'}}>
       <div className='d-flex justify-content-evenly flex-wrap'>
         ...
         <div className="link d-flex flex-column">
          ...
          <Link to={"/allblogs"}  style={{textDecoration:"none", color:'white'}}>Blogs</Link>
